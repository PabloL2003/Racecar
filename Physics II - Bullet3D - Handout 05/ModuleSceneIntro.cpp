...
bool ModuleSceneIntro::Start()
{
	...
	// 
	//recta//
	addCube({ -85,0,0 }, { 8,0.3f,160 }, { 1,1,1 }, 0, 0, 0);
	...
	//segunda curba// 
	addCube({ -84,0,-84 }, { 6,0.3f,10 }, { 1,1,1 }, 0, -15, 0);
	addCube({ -81,0,-91 }, { 6,0.3f,10 }, { 1,1,1 }, 0, -35, 0);
	addCube({ -76,0,-96 }, { 6,0.3f,10 }, { 1,1,1 }, 0, -65, 0);
	addCube({ -68,0,-97 }, { 6,0.3f,10 }, { 1,1,1 }, 0, -95, 0);
	addCube({ -54,0,-86 }, { 6,0.3f,30 }, { 1,1,1 }, 0, -135, 0);
